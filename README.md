...
### ll1ness - Full-Stack разработчик | Владелец платформы 'ViraXis' [Russian Version](https://github.com/ll1ness/ll1ness/blob/main/READMEru.md)
...
I am also the owner of the platform [ViraXis Platfrom](https://viraxis.hopto.org/), my site with my portfolio of works, and on the site you can find a tutorial for novice encoders and users of GitHub and tools for professionals, for example, in plans to create your own 'DevelvWire' for programming in PHP.
